  ...
  return (
    // <div className="h-full w-full justify-center align-middle">
      ...
      <form className="flex flex-col gap-2 h-3/4 w-5/6 sm:w-2/3 md:w-1/2 bg-yellow-50 m-auto text-center p-16 mt-4 shadow-lg border-zinc-400 border-opacity-25 border-2 font-cursive text-2xl text-zinc-900 min-w-[300px] min-h-[525px]">
        ...
        <h1 className="text-4xl mb-4 underline decoration-2">Log In</h1>
        ...
        />
        <button className="bg-[#e6e5d9] w-3/4 mx-auto mt-4 p-2 rounded-md hover:outline-dashed hover:outline-2 hover:outline-zinc-300 focus:outline-dashed focus:outline-2 focus:outline-zinc-400">Log In</button>
        <div className="w-full h-0.5 mt-4 bg-zinc-400 opacity-25"/>
        <p className="text-zinc-900 hover:text-gray-400 mt-2">
          <Link className="group" href="/signup">Don't have an account yet?<span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gray-400 transition-all group-hover:w-full"></span></Link></p>
      </form>
    // </div>
  )
} 